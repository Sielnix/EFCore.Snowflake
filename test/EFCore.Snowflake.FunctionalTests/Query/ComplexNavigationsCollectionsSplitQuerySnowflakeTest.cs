...
public class ComplexNavigationsCollectionsSplitQuerySnowflakeTest
    : ComplexNavigationsCollectionsSplitQueryRelationalTestBase<ComplexNavigationsQuerySnowflakeFixture>
{
    public ComplexNavigationsCollectionsSplitQuerySnowflakeTest(
    ...
    {
        await Assert.ThrowsAsync<SnowflakeDbException>(async () => await base.Complex_query_issue_21665(async));
    }
